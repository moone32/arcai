...
import { 
  ...
  ArrowRight, Video as VideoIcon, Wifi as WifiIcon, CloudCog, MonitorPlay, Smartphone
} from 'lucide-react';
import './Products.css';
  ...
  const products = [
    {
      ...
      icon: <Video size={80} strokeWidth={1} color="#334155" />
    },
    {
      id: 2,
      badge: 'AI 영상 분석',
      ...
      icon: <Cctv size={80} strokeWidth={1} color="#334155" />
    },
    {
      id: 3,
      badge: '위험 알림',
      ...
      icon: <Siren size={80} strokeWidth={1} color="#ef4444" />
    },
    {
      id: 4,
      badge: '변위 모니터링',
      ...
      icon: <RadioReceiver size={80} strokeWidth={1} color="#334155" />
    },
    {
      id: 5,
      badge: '가스 감지',
      ...
      icon: <Flame size={80} strokeWidth={1} color="#f97316" />
    },
    {
      id: 6,
      badge: '현장 지원',
      ...
      icon: <BatteryCharging size={80} strokeWidth={1} color="#334155" />
    }
  ];
        ...
        <div className="container products-hero-container">
          <div className="products-hero-text">
            ...
            <h1 className="ph-title">
              현장에 최적화된<br />
              <span style={{ color: '#059669' }}>AI 안전 장비</span>
            </h1>
            <p className="ph-desc">
            ...
            {products.map(product => (
              <div className="product-card" key={product.id}>
                ...
                <div className="prod-body">
                  ...
                  <a href="#detail" className="prod-link">
