  ...
  return (
    <section className="core-functions section section-light" id="functions">
      <div className="container">
        <h2 className="section-title text-left title-with-bar">ARCAI 솔루션 핵심기능</h2>

        <div className="functions-grid">
          {functions.map((fn) => (
            <div className="function-card" key={fn.id} onClick={() => navigateTo('/solutions')} style={{ cursor: 'pointer' }}>
