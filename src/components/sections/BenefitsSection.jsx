  ...
  const benefits = [
    {
      icon: (
        <div className="custom-icon-wrapper">
          <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            {/* 사람 머리 옆모습 실루엣 */}
            ...
            <text x="8" y="13.5" fontSize="6.5" fontWeight="800" fill="#059669" stroke="none">AI</text>
          </svg>
        </div>
      ),
      label: '사고 위험',
    ...
    },
    {
      icon: (
        <div className="custom-icon-wrapper">
          <Clock size={44} strokeWidth={1.8} color="#059669" />
        </div>
      ),
      label: '관리 시간',
      highlight: '▼ 50%',
    ...
    },
    {
      icon: (
        <div className="custom-icon-wrapper">
          <ShieldCheck size={44} strokeWidth={1.8} color="#059669" />
        </div>
      ),
      label: '지원금 연계 가능',
      highlight: null,
      ...
      icon: (
        <div className="custom-icon-wrapper">
          <svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
            ...
            <text x="8" y="14.5" fontSize="6.5" fontWeight="800" fill="#059669" stroke="none">AI</text>
          </svg>
        </div>
      ),
      label: 'AI 24시간 관제',
